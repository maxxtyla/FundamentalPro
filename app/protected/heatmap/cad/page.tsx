...
// ── Main page ────────────────────────────────────────────────────────────────
export default function CADHeatmapPage() {
  ...
  const impactCounts = {
    bullish: data.filter((d) => d.cad_impact === "bullish").length,
    bearish: data.filter((d) => d.cad_impact === "bearish").length,
    neutral: data.filter((d) => d.cad_impact === "neutral").length,
  };
  ...
  const sentimentConfig = {
    bullish: {
      ...
      desc: "Macro conditions favour CAD strength.",
      color: "text-blue-300",
      bg: "bg-blue-500/10",
    ...
    bearish: {
      ...
      desc: "Macro conditions weigh on CAD.",
    ...
    neutral: {
      ...
      desc: "No clear directional bias for CAD.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <div className="mb-6 sm:mb-8 animate-fade-in">
          ...
          <p className="text-slate-500 text-xs sm:text-sm mt-2">
            Canadian Dollar · Macro Dashboard · Q1 2026
          </p>
        </div>
                      ...
                      {rows.map((row) => (
                        ...
                        >
                          <div className="flex items-start justify-between gap-2">
                            ...
                            <ImpactBadge impact={row.cad_impact} />
                          </div>
                          ...
                          <div className="flex items-center justify-between pt-2 border-t border-slate-800">
                            ...
                            <ImpactBadge impact={row.cad_stocks_impact} />
                          </div>
                        </div>
                      ))}
                    </div>
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-slate-700">
                            {["Metric", "Date", "Actual", "Forecast", "Previous", "vs Fcst", "CAD", "Stocks"].map((h) => (
        ...
        <div className="mt-8 pt-4 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-600">
          <span className="uppercase tracking-widest">
            CAD Macro Heatmap · {loading ? "—" : data.length} Indicators
          </span>
