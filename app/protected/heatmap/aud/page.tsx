...
// ── Main page ────────────────────────────────────────────────────────────────
export default function AUDHeatmapPage() {
  ...
  const impactCounts = {
    bullish: data.filter((d) => d.aud_impact === "bullish").length,
    bearish: data.filter((d) => d.aud_impact === "bearish").length,
    neutral: data.filter((d) => d.aud_impact === "neutral").length,
  };
  ...
  const sentimentConfig = {
    bullish: {
      ...
      desc: "Macro conditions favour AUD strength.",
      color: "text-blue-300",
      bg: "bg-blue-500/10",
    ...
    bearish: {
      ...
      desc: "Macro conditions weigh on AUD.",
    ...
    neutral: {
      ...
      desc: "No clear directional bias for AUD.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <div className="mb-6 sm:mb-8 animate-fade-in">
          ...
          <p className="text-slate-500 text-xs sm:text-sm mt-2">
            Australian Dollar · Macro Dashboard · Q1 2026
          </p>
        </div>
                      ...
                      {rows.map((row) => (
                        ...
                        >
                          <div className="flex items-start justify-between gap-2">
                            <div>
                              ...
                              <div className="text-xs text-slate-500 mt-0.5">
                                {new Date(row.release_date).toLocaleDateString("en-AU", { 
                                  day: "2-digit", 
                                  month: "short", 
                                  year: "numeric" 
                                })}
                            ...
                            <div className="flex gap-1">
                              <ImpactBadge impact={row.aud_impact} />
                            </div>
                          </div>
                          ...
                          <div className="flex items-center justify-between pt-2 border-t border-slate-800">
                            ...
                            <ImpactBadge impact={row.aud_stocks_impact} />
                          </div>
                        </div>
                      ))}
                    </div>
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-slate-700">
                            {["Metric", "Date", "Actual", "Forecast", "Previous", "vs Fcst", "AUD", "Stocks"].map((h) => (
        ...
        <div className="mt-8 pt-4 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-600">
          <span className="uppercase tracking-widest">
            AUD Macro Heatmap · {loading ? "—" : data.length} Indicators
          </span>
